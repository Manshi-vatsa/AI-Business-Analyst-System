...
public final class ItemInsightBinding implements ViewBinding {
  ...
  private ItemInsightBinding(@NonNull MaterialCardView rootView, @NonNull TextView textViewCategory,
  ...
  public static ItemInsightBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemInsightBinding((MaterialCardView) rootView, textViewCategory,
          textViewDescription, textViewTimestamp, textViewTitle);
    }
