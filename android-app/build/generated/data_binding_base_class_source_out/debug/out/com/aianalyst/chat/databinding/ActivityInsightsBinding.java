...
public final class ActivityInsightsBinding implements ViewBinding {
  ...
  private ActivityInsightsBinding(@NonNull LinearLayout rootView,
      ...
      @NonNull RecyclerView recyclerViewInsights, @NonNull TextView textViewEmpty,
      @NonNull TextView textViewError, @NonNull MaterialToolbar toolbar) {
  ...
  public static ActivityInsightsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityInsightsBinding((LinearLayout) rootView, bottomNavigation, progressBar,
          recyclerViewInsights, textViewEmpty, textViewError, toolbar);
    }
